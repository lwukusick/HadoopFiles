...
crime_data_subset = FOREACH crime_data GENERATE $0#'date' AS date, $0#'latitude' AS latitude, $0#'longitude' AS longitude, $0#'primary_type', $0#'description', $0#'fbi_code', $0#'arrest', $0#'domestic';
